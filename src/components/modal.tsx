...
export default function Modal({ open, children, onClose }: IModal) {
  if (open) {
    return createPortal(
      <div className="fixed top-2/4 left-2/4 bg-white -translate-y-2/4 -translate-x-2/4 pin z-50 overflow-auto rounded-lg text-left shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
